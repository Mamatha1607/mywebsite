function About() {
  return (
    <section
      id="about"
      className="min-h-screen px-6 py-20 bg-white-50 dark:bg-base text-gray-900 dark:text-white flex flex-col md:flex-row items-center justify-between gap-12"
    >
      {/* Text Content */}
      <div className="md:w-7/12 flex flex-col justify-center h-full text-left">
        <h2 className="text-5xl md:text-6xl font-bold mb-8 text-accent">About Me</h2>
  ...
  className="w-[48rem] h-[48rem] object-cover rounded-lg border-2 border-accent 
